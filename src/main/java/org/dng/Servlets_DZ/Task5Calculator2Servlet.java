...
@WebServlet(name = "CalculatorServlet", value = "/Calculator2")
public class Task5Calculator2Servlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("/Task5Calculator2.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String buttonAction = request.getParameter("selectedAction");
...
//            String str = (String) request.getSession().getAttribute("result2");
